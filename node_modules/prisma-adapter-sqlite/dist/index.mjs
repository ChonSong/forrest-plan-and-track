...
var debug = Debug("prisma:driver-adapter:sqlite:conversion");
...
// src/sqlite.ts
var debug2 = Debug2("prisma:driver-adapter:sqlite");
...
var PrismaSqliteAdapterFactory = class {
  ...
  constructor(config, options) {
    ...
    if (isNaN(majorNodeVersion) || majorNodeVersion < 24) {
      throw new Error("prisma-adapter-sqlite requires Node.js v24 or higher");
    }
  }
  connect() {
...
export {
  PrismaSqliteAdapterFactory as PrismaSqlite
};
